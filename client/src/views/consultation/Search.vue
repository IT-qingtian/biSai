    ...
    <div class="search-page">
        ...
        <div class="search-header">
            <div class="search-container">
                <el-input v-model="searchQuery" placeholder="搜索文章、问答或用户" class="search-input"
        ...
        <div class="search-content">
            <div class="search-sidebar">
                <el-menu :default-active="activeTab" class="search-menu" @select="handleSelect">
                    <el-menu-item v-for="type in searchTypes" :key="type.key" :index="type.key">
                        {{ type.label }}
                        <template #title>
            ...
            <div class="search-results">
                ...
                <template v-if="searchResults[activeTab]?.length">
                    <div v-for="result in searchResults[activeTab]" :key="result.id" class="result-item">
                ...
                <!-- 无结果显示 -->
                <el-empty v-else description="暂无搜索结果" :image-size="200" />
            </div>
        </div>
    </div>
</template>
